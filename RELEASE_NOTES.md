...
| Platform | File |
|----------|------|
| **macOS** (Apple Silicon) | `Disc.Xplorer_macOS_ARM_v1.9.6.zip` |
| **Windows** (x64) | `Disc.Xplorer_Windows_x64_v1.9.6.exe` |
| **Windows** (ARM) | `Disc.Xplorer_Windows_ARM_v1.9.6.exe` |
| **Linux** (x64) | `Disc.Xplorer_Linux_x64_v1.9.6.AppImage` |
| **Linux** (ARM) | `Disc.Xplorer_Linux_ARM_v1.9.6.AppImage` |
